...
function RouteComponent() {
	...
	return (
		<div className='col-span-1 md:col-span-12'>
			<div className='px-6 pt-5 sm:mx-auto sm:max-w-2xl md:max-w-4xl'>
			...
			<div className='grid grid-cols-1 px-6 py-3 sm:mx-auto sm:max-w-2xl md:max-w-4xl md:grid-cols-2 md:gap-10'>
				...
				<div className='px-2'>
					...
					<div className='mb-2 flex items-center gap-1 sm:mb-3'>
						<FaStar className='h-4 w-4 text-yellow-400 sm:h-5 sm:w-5 md:h-4 md:w-4' />
						<FaStar className='h-4 w-4 text-yellow-400 sm:h-5 sm:w-5 md:h-4 md:w-4' />
						<FaStar className='h-4 w-4 text-yellow-400 sm:h-5 sm:w-5 md:h-4 md:w-4' />
						<FaStar className='h-4 w-4 text-yellow-400 sm:h-5 sm:w-5 md:h-4 md:w-4' />
						<FaRegStar className='h-4 w-4 text-yellow-400 sm:h-5 sm:w-5 md:h-4 md:w-4' />
						<p className='text-sm sm:text-lg md:text-sm'>({book.rating})</p>
					</div>
					...
					<div className='mb-8 md:mb-10'>
						...
						<div>
							<p
								className={`text-sm font-light text-gray-500 sm:text-[16px] md:text-[15px] ${!descExpanded ? 'line-clamp-4 md:line-clamp-7' : ''}`}
							>
								{book.description}
							</p>
