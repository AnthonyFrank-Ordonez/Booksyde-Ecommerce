...
export default function NewArrival({
	...
	return (
		<section className='bg-gray-100'>
			<ScrollFadeSection className='2xl:gap-5r flex flex-col gap-10 px-12 py-12 md:flex-row md:gap-5 lg:flex-row lg:gap-5 xl:flex-row xl:gap-5 2xl:px-[3rem]'>
				<div className='flex flex-1 flex-col'>
					...
					<p className='mt-5 text-sm font-normal text-gray-500 md:mt-3 md:max-w-sm md:text-sm lg:mt-4 lg:max-w-md lg:text-lg xl:mt-5 xl:max-w-lg 2xl:max-w-xl 2xl:text-xl'>
						{description}
					</p>
					<div></div>
					<Link
				...
				<div className='flex flex-1 items-center justify-center md:justify-end lg:justify-end xl:justify-end 2xl:justify-end'>
					<div className='relative flex h-auto w-auto items-center justify-center overflow-hidden rounded-md bg-gray-200/50 md:h-[27rem] md:w-[22rem] lg:h-[33em] lg:w-[26rem] xl:h-[40rem] xl:w-[34rem] 2xl:h-[50rem] 2xl:w-[40rem]'>
						<img
							src={imageUrl}
							alt={imageAlt}
							className='mx-auto h-auto w-auto object-cover md:h-[22rem] md:w-62 lg:h-[26rem] lg:w-70 xl:h-[30rem] xl:w-90 2xl:h-[40rem] 2xl:w-[28rem]'
						/>
					</div>
				</div>
			</ScrollFadeSection>
